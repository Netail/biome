...
function Valid4() {
	...
	useEffect(() => {
		...
		const observer = new IntersectionObserver(() => console.log('intersection'));
...
function Valid9() {
	useEffect(() => {
		...
		const observer = new IntersectionObserver(getAndSetScrollOffsets);
		observer.observe(scrollRoot);

		return () => {
			observer.unobserve(scrollRoot);
		};

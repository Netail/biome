...
impl RuleName {
    pub const fn as_str(self) -> &'static str {
        match self {
            ...
            Self::NoEmptyDocumentation => "noEmptyDocumentation",
    ...
    pub const fn group(self) -> RuleGroup {
        match self {
            ...
            Self::NoEmptyDocumentation => RuleGroup::Nursery,
...
impl std::str::FromStr for RuleName {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s {
            ...
            "noEmptyDocumentation" => Ok(Self::NoEmptyDocumentation),
...
impl RuleGroupExt for Nursery {
    ...
    fn get_enabled_rules(&self) -> FxHashSet<RuleFilter<'static>> {
        ...
        if let Some(rule) = self.no_empty_documentation.as_ref()
            && rule.is_enabled()
        {
            index_set.insert(RuleFilter::Rule(Self::GROUP_NAME, Self::GROUP_RULES[2]));
        }
    ...
    fn get_rule_configuration(
        ...
        match rule_name {
            ...
            "noDuplicateDependencies" => self
                ...
                .as_ref()
                .map(|conf| (conf.level(), conf.get_options())),
            "noEmptyDocumentation" => self
                .no_empty_documentation
                .as_ref()
                .map(|conf| (conf.level(), conf.get_options())),
            "noEmptySource" => self
                .no_empty_source
...
impl From<GroupPlainConfiguration> for Nursery {
    fn from(value: GroupPlainConfiguration) -> Self {
        Self {
            ...
            no_empty_documentation: Some(value.into()),

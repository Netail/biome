...
impl RuleName {
    pub const fn as_str(self) -> &'static str {
        match self {
            ...
            Self::NoReactLeakedObserver => "noReactLeakedObserver",
    ...
    pub const fn group(self) -> RuleGroup {
        match self {
            ...
            Self::NoReactLeakedObserver => RuleGroup::Nursery,
...
impl std::str::FromStr for RuleName {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s {
            ...
            "noReactLeakedObserver" => Ok(Self::NoReactLeakedObserver),
